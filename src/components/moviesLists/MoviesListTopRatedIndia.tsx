...
import { getMoviesTopRatedIndia } from "../../services/Movies";
...
class MoviesListTopRatedIndia extends Component<Props, State> {
    state: State = {
        status: 'LOADING'
    };
    ...
    async componentDidMount() {
        ...
        try {
            const data = await getMoviesTopRatedIndia();
            this.setState({
                status: 'LOADED',
                movies: data
            });
...
export default MoviesListTopRatedIndia;