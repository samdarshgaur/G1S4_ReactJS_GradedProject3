...
import { getMoviesFavorite } from "../../services/Movies";
...
class MoviesListFavorites extends Component<Props, State> {
    state: State = {
        status: 'LOADING'
    };
    ...
    async componentDidMount() {
        ...
        try {
            const data = await getMoviesFavorite();
            this.setState({
                status: 'LOADED',
                movies: data
            });
...
export default MoviesListFavorites;